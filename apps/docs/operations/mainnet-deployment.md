...
- [ ] `MERIDIAN_ALERT_WEBHOOK_URL` configured before the alert keeper does anything beyond its current clean no-op (see `isAlertKeeperConfigured`, PR #735). Venue decided (Discord), not yet set up.
