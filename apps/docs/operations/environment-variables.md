...
| `UPSTASH_REDIS_REST_TOKEN`               | Yes (prod)   | `""`                               | Auth token for `UPSTASH_REDIS_REST_URL`. Same requirement and same consumers.                                                                                                                                                                                                                                                                                            |
